...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibXhzc2lpaSIsImEiOiJjbGVkaHlnZDAwNnpwM3lvMDJiY3pkeWl6In0.PISyHgDCHd6vnbyt6QlBVA';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/mxssiii/cledi192n008j01p2yji39nfx',
    scrollZoom: false
      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'POST',
            url: "".concat(location.origin, "/api/v1/users/login"),
            data: {
              email: email,
              password: password
            }
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'GET',
            url: "".concat(location.origin, "/api/v1/users/logout")
          });
        case 3:
          res = _context2.sent;
          if (res.data.status = 'success') {
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          url = type === 'password' ? "".concat(location.origin, "/api/v1/users/updateMyPassword") : "".concat(location.origin, "/api/v1/users/updateMe");
          _context.next = 4;
          return (0, _axios.default)({
            method: 'PATCH',
            url: url,
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return (0, _axios.default)("".concat(location.origin, "/api/v1/bookings/checkout-session/").concat(tourId));
        case 3:
          session = _context.sent;
          _context.next = 6;
          return Stripe('pk_test_51MeAZ9JGXxWj3qqhXvpJxmL59A7vpdk7ogQZLwxHJ8w008fbfqYDjyxdQ3nLIOR83Jt754VEWfJDSI8if2bHn31v00vwiGebzn').redirectToCheckout({
